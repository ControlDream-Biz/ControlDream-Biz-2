...
export default function BackToTop() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className="fixed bottom-32 right-6 z-[10000] w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 flex items-center justify-center group animate-float-button"
      style={{
