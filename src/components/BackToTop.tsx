...
export default function BackToTop() {
  ...
  return (
    <button
      onClick={scrollToTop}
      className="fixed bottom-24 right-6 z-[9999] w-14 h-14 bg-gradient-to-br from-blue-500 to-indigo-600 text-white rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 flex items-center justify-center group"
      style={{
