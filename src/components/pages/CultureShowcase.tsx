      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 max-w-7xl mx-auto py-8 sm:py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 md:gap-16 w-full max-w-6xl">
          ...
          >
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white">{t('culture.innovation.title')}</h3>
          ...
          >
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white">{t('culture.care.title')}</h3>
            <p className="text-base sm:text-lg md:text-xl text-white/60 leading-relaxed">
              {t('culture.care.description')}
            </p>
          </div>
          ...
          >
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white">{t('culture.responsibility.title')}</h3>
            <p className="text-base sm:text-lg md:text-xl text-white/60 leading-relaxed">
              {t('culture.responsibility.description')}
            </p>
          </div>
          ...
          >
            ...
            <h3 className="text-xl sm:text-2xl md:text-3xl font-black text-white">{t('culture.collaboration.title')}</h3>
            <p className="text-base sm:text-lg md:text-xl text-white/60 leading-relaxed">
