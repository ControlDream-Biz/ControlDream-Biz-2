...
export const CultureShowcase = memo(function CultureShowcase({ isActive = true }: CultureShowcaseProps) {
  ...
  return (
    <div 
      ...
      style={{ 
        zIndex: 5,
        background: `radial-gradient(circle at 50% 50%, rgba(168, 85, 247, 0.12) 0%, rgba(168, 85, 247, 0.06) 30%, rgba(0, 0, 0, 1) 70%)`,
      }}
    >
      {/* 背景光晕 */}
      <div
        ...
        style={{
          ...
          background: 'radial-gradient(circle at 50% 50%, rgba(168, 85, 247, 0.2) 0%, transparent 60%)',
        }}
      />
