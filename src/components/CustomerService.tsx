  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-16 right-6 z-[9999] w-14 h-14 bg-gradient-to-br from-green-500 to-emerald-600 text-white rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 flex items-center justify-center group animate-float-button"
        style={{
      ...
      {isOpen && (
        <div
          className="fixed bottom-32 right-6 z-[9999] w-80 bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden animate-menu-slide-down"
          style={{
            transform: 'translateZ(0)',
